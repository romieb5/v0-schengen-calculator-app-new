...
export function Navigation() {
  ...
  return (
    <>
      ...
      >
        <button className="bg-yellow-400 hover:bg-yellow-500 text-black rounded-full p-3 shadow-lg transition-all hover:scale-110 flex items-center justify-center">
          <Coffee className="h-6 w-6" fill="currentColor" />
        </button>
      </Link>
    </>
  )
